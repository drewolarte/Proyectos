...
<head>
    <title>Gestionar Proyectos Director</title>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        ...
        <sql:query var="result" scope="request" dataSource="${universidad}">
            Select * from estudiante where docente_id_docentedirector=?
                ...
                <tbody>
                    <c:forEach var="fila" items="${result.rows}">
                        <tr>
                            ...
                            <td class="align-middle">
                                <form action="gestionarEstudianteDirector.jsp" method="POST">
