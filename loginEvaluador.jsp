...
<body>
    <div class="container">
        ...
        <h2 class="text-center" id="titulo">LOGIN EVALUADOR</h2>
            <form method="POST">
        ...
        <c:if test="${param.modifica != null}">
            ...
            <sql:query var="result" dataSource="${universidad}" sql="SELECT * FROM docente WHERE id_docente=? and contrasena_docente=? and roles_id_evaluador=?">
            ...
            <c:forEach var="row" items="${result.rows}">
                <c:if test="${row.id_docente==param.user&&row.contrasena_docente==param.pwd}">
                    ...
                    <c:redirect url="indexEvaluador.jsp"/>
                </c:if>
            </c:forEach>
            <br>
