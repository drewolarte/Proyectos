...
<body>
    <div class="container">
        ...
        <h2 class="text-center" id="titulo">Bienvenido: <c:out value="${admin.nombre_docente} ${admin.apellido_docente}"/></h2>
        <h3 class="text-center" id="titulo">Identificacion: <c:out value="${admin.id_docente}"/></h3>
        <br>
        ...
        <div class="container d-flex justify-content-center">
            <div class="card bg-light text-dark m-1" style="width:300px" >
                <div class="card-body d-flex flex-column justify-content-center text-center">
                    ...
                    <form action="gestionarProyectosEvaluador.jsp" method="POST">
