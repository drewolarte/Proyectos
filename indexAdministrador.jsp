...
<body>
    <div class="container">
        ...
        <h2 class="text-center" id="titulo">Bienvenido: <c:out value="${admin.nombre_administrador} ${admin.apellido_administrador}"/></h2>
        <h3 class="text-center" id="titulo">Identificacion: <c:out value="${admin.id_administrador}"/></h3>
        <br>
                                
        <div class="container d-flex justify-content-center">
            <div class="card bg-light text-dark m-1" style="width:300px" >
                <div class="card-body d-flex flex-column justify-content-center text-center">
                    <span class="material-symbols-outlined" width="70px">group</span>
                    <p class="card-text">Gestionar Usuarios</p>
                    <form action="gestionarUsuarios.jsp" method="POST">
            ...
            <div class="card bg-light text-dark m-1" style="width:300px" >
                <div class="card-body d-flex flex-column justify-content-center text-center">
                    <span class="material-symbols-outlined" width="70px">science</span>
                    <p class="card-text">Gestionar Linea de Investigacion</p>
                    <form action="gestionarInvestigacion.jsp" method="POST">
                        <button type="submit" class="btn">
                            <a class="btn btn-outline-dark">Gestionar</a>
                        </button>
                    </form>
