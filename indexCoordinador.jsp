...
<body>
    <div class="container">
        ...
        <h2 class="text-center" id="titulo">Bienvenido: <c:out value="${admin.nombre_coordinador} ${admin.apellido_coordinador}"/></h2>
        <h3 class="text-center" id="titulo">Identificacion: <c:out value="${admin.id_coordinador}"/></h3>
        <br>
                                
        <div class="container d-flex justify-content-center">
            <div class="card bg-light text-dark m-1" style="width:300px" >
                <div class="card-body d-flex flex-column justify-content-center text-center">
                    <span class="material-symbols-outlined" width="70px">biotech</span>
                    <p class="card-text">Gestionar Proyectos</p>
                    <form action="gestionarProyectosCoordinador.jsp" method="POST">
