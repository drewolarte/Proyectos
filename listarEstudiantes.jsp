...
<body>
    <div class="container">
        ...
        <br>
        <h1 class="text-center" id="titulo">Gestión de Estudiantes</h1>
        <br>
        <sql:query var="estudiante" scope="request" dataSource="${universidad}">
        ...
        <table class="table table-bordered table-hover text-center">
            ...
            <tbody>
                <c:forEach var="fila" items="${estudiante.rows}">
                    ...
                    <tr>
                        <td class="align-middle"><c:out value="${fila.id_estudiante}"/></td>
                        ...
                        <td class="align-middle">
                            <form action="eliminarEstudiante.jsp" method="POST">
                                <input type="hidden" name="id" value="${fila.id_estudiante}">
                                <input type="hidden" name="contrasena" value="${fila.contrasena_estudiante}">
                                <button type="submit" class="btn btn-outline-info">Eliminar</button>
                            </form>
                        </td>
                        <td class="align-middle">
                            <form action="actualizarEstudiante.jsp" method="POST">
                                <input type="hidden" name="id" value="${fila.id_estudiante}">
                                <input type="hidden" name="contrasena" value="${fila.contrasena_estudiante}">
        ...
        <form action="agregarEstudiante.jsp" method="POST">
            <button type="submit" class="btn btn-outline-primary btn-block">Nuevo Estudiante</button>
        </form>
