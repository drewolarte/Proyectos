...
<head>
    <title>Gestionar Proyectos Evaluador</title>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        ...
        <sql:query var="result" scope="request" dataSource="${universidad}">
            Select * from estudiante where docente_id_docenteevaluador_anteproyecto=?
            <sql:param value="${admin.id_docente}"/>
        </sql:query>
        <div class="d-flex justify-content-center">
                ...
                <tbody>
                    <c:forEach var="fila" items="${result.rows}">
                        <tr>
                            ...
                            <td class="align-middle">
                                <form action="gestionarEstudianteEvaluador.jsp" method="POST">
